...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      {
        source:'/cities/:city/top-sightseeing-places-and-attractions-to-visit-:id',
        destination:'/places/:city/places-to-visit-:id',
        permanent: true,
      },
      {
        source:'/places/:city/-:id',
        destination:'/places/:city-:id',
        permanent: true
      },
      {
        source:'/states/:state/-:id',
        destination:'/states/:state-:id',
        permanent: true
      },
      {
        source:'/countries/:country/-:id',
      ...
      {
        source:"/holidays/:slug-package-tour-package-:id",
        destination: "/holidays",
        permanent : true
      },
      {source:'/holidays/city-theme', destination: '/holidays', permanent: true},
      {source: '/travel-guide/india/detail', destination: '/travel-guide',permanent: true},
      {source: '/travel-guide/places', destination: '/travel-guide', permanent: true},
      {source: '/travel-articles/detail', destination: '/travel-articles', permanent: true},
      {source: '/travel-guide/country', destination: '/travel-guide', permanent: true},
      // {source: '/hotel-infinity-resorts-corbett-in-jim-corbett-612838', destination: '/410', permanent: true},
      // {source: '/qna', destination: '/410', permanent: true},

      {source: '/holidays/theme', destination: '/holidays', permanent: true},
      {source:'/holidays/city-package', destination: '/holidays', permanent: true},
      {source:'/holidays/%5bname%5d-tour-package-%5bid%5d', destination: '/holidays', permanent: true},
      {source: '/holidays/undefined-tour-packages-undefined3', destination: '/holidays', permanent: true},
      {source: '/holidays1', destination: '/holidays',permanent: true},
      {source: '/states1', destination: '/states', permanent: true},
      {source: '/states/uttarakhand', destination: '/states', permanent: true},
      {source: '/attractions/lake-mist-in-mussoorie', destination: '/attractions', permanent: true},
      {source: "/places/mussoorie/things-to-do-14811", destination: '/places', permanent: true},
      ...
      {source: "/states/null",destination:"/states",permanent:true},
      {source: "/states/mizoram-undefined",destination:"/states",permanent:true},
      {source: "/states/andhra-pradesh-undefined",destination:"/states",permanent:true},
      {source: "/states/null",destination:"/states",permanent:true},
  ...
  async rewrites() {
    return [
      ...
      // },
      {source: '/hotel-infinity-resorts-corbett-in-jim-corbett-612838', destination: '/410'},
      {source: '/qna', destination: '/410'},
      {
