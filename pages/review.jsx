...
const Customer_Review = ({ userinfo }) => {
  ...
  const postReview = async (e) => {
    ...
    for (var index = 0; index < totalfiles; index++) {
      leaddata.append(
        "files",
        document.getElementById("file-upload").files[index],
      );
    }
    ...
    if (response?.data?.result === "success") {
      swal("", "Thanks for your Valuable Feedback. ", "success").then(
  ...
  const getLeadInfo = () => {
    const leadifo = axios
      .post(Constants.api + "/api/v1/lead/get-info/" + router.query.token, {
    ...
    <>
      ...
      <div className="_70">
        {userinfo == null ? (
          ...
          >
            <h2 style={{ color: "#f06726", textAlign: "center" }}>
              Feedback has already been submitted. Thank you.
            </h2>
          </div>
        ) : (
          <>
                  ...
                  <div class="row">
                    <div class="col-sm-12 col-xs-12">
                      ...
                      <div style={{ display: "flex" }}>
                        ...
                        >
                          <p class="your_feed" style={{ fontWeight: "bolder" }}>
                            {userinfo.nm}
                          </p>
...
export async function getServerSideProps(context) {
  ...
  const leadifo = await axios.post(
    Constants.api + "/api/v1/lead/get-info/" + context.query.token,
    { id: context.query.token },
  );
