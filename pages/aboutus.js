    ...
    return <>
            ...
            <div>
                <div className="terms-inner-section">
                    ...
                    <div className={tw`p-4`}>
                        <h4 className="text-center text-uppercase mb-4 fw-bold fs-6">About Us</h4>
                    ...
                    <div className={tw`terma-box _box_shadow bg-white my-5 p-5`}>
                        <h4 className="text-center text-uppercase my-4 fw-bold fs-6">Team</h4>
                        <p className="text-center">
                            ...
                            'also ran'. At present the following teams are working at
                            Kiomoi
                        </p>
                    </div>

                    <div className={tw`terma-box _box_shadow bg-white my-5 p-5`}>
                        <h4 className="text-center text-uppercase my-4 fw-bold fs-6">Founder</h4>
                        <p className="text-center">
                            Kiomoi is a travel start-up founded by veterans of the online
                            travel industry and worked with the best online travel brands
                            of the country as a core team members.
                        </p>
                    </div>

                    <div className={tw`terma-box _box_shadow bg-white my-5 p-5`}>
                        <h4 className="text-center text-uppercase my-4 fw-bold fs-6">Sales Team</h4>
                        <p className="text-center">
                            A young bunch, who are the lifeline of Kiomoi, they are
                            responsible for capturing and converting the leads. Always
                            busy like a bee.
                        </p>
                    </div>

                    <div className={tw`terma-box _box_shadow bg-white my-5 p-5`}>
                        <h4 className="text-center text-uppercase my-4 fw-bold fs-6">B.D. Team</h4>
                        <p className="text-center">
                            A portfolio that involves lots of traveling across the
                            country, signing up best local suppliers, best experiences
                            (Home stays, Hotels, Car vendors & Local guides) to keep
                            Kiomoi offering most cost effective and competitive with best
                            of care.
                        </p>
                    </div>

                    <div className={tw`terma-box _box_shadow bg-white my-5 p-5`}>
                        <h4 className="text-center text-uppercase my-4 fw-bold fs-6">Tech Team</h4>
                        <p className="text-center">
                            The 'brain of Kiomoi' Takes care of all the hardcore tech
                            things like site enhancement, maintenance of existing sites,
                            Admin, Booking Engine optimization et al. They are the people
                            working relentlessly to troubleshoot all the involved
                            systemsâ€¦
                        </p>
                    </div>

                    <div className={tw`terma-box _box_shadow bg-white my-5 p-5`}>
                        <h4 className="text-center text-uppercase my-4 fw-bold fs-6">Content & SEO</h4>
                        <p className="text-center">
                            Responsible for all matters 'Cerebral' the very face behind
                            the soon to be launched Travel Guides, Blogs, PRs and all that
                            you see written at Kiomoi's website. SEO is virtually a
                            one-man army constantly pushing and striving for improving the
                            rankings and search ability of Kiomoi.
                        </p>
                    </div>

                    <div className={tw`terma-box _box_shadow bg-white my-5 p-5`}>
                        <h4 className="text-center text-uppercase my-4 fw-bold fs-6">Career</h4>
                        <p className="text-center">
                            Yes! We are Hiring! If you feel that you can add some value in
                            any of the domain you are welcome, please share your profile
                            on info@kiomoi.com
                        </p>
                    </div>
                </div>
        ...
        <div show={second} animation={false}>
            <div>
                ...
                <center>
                    <a href="mailto:CAREER@KIOMOI.COM" className="career-a font-semibold" style={{ color: '#007bff' }}>
                        CAREER@KIOMOI.COM
                    </a>
                </center>
            </div>
