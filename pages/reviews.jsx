...
const Reviews = ({reviews}) =>{
    ...
    <div className="container">
        <div>
            <h2 className="text-2xl text-center py-10 bg-white">People tell about kiomoi</h2>
        </div>
        <div>
...
export async function getServerSideProps(context) {
    ...
    const res = await client.query({query:getreviewsQuery,variables:{input:payload}})
