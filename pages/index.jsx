...
import { getarticleQuery, getbanner, getHome,getreviewsQuery,getTravelGuideHome } from "../components/Graphql/Queries";
...
const Home_Page = ({home,travel,reviews,articles}) =>{
...
export async function getServerSideProps(context) {
    ...
    return {props:{home:res.data.home.output,travel:res_travel.data.travelguide.output,reviews:res_review.data.reviews.output,articles:res_article.data.articles.output}}
