...
const TravelGuideDetailComp = ({ meta,packages_state,data, weather, packages, hotels, article, qna,type ,state_t=undefined}) => {
    ...
    const imagesRender = data.images.map((img, index) => {
        return <div key={index}>
            <Image src={jpgToWebp({uri:img.i})} alt="images" className={`img rounded-[8px]`} layout="fill"/>
        </div>
    })
    ...
    const rightBlock = ({ icon, heading, desc }) => {
        return <div className={`flex pb-2`}>
            <div>
                <img src={`${Constants.assets_api}/public/icons/${icon}`} alt="icon" className={`inline h-[15.7px]`} />
            </div>
            <div className={`ml-4`}>
    ...
    return <>
        ...
        <section className="container">
            ...
            {
                type=='CITY'?<h1 className={`text-2xl font-bold`}>{data.tg.cityName}</h1>:                
                <h1 className={`text-2xl font-bold`}>Places To Visit in {data.tg.cityName}</h1>
            }
            </div>
            ...
            <div className={tw`flex flex-wrap`}>
                ...
                <div className={tw`w-full lg:w-1/3`}>
                    <div className={tw`pl-0 lg:pl-6 `}>
                                            ...
                                            :<>
                                                ...
                                                <div className={`w-full lg:1/2`}>
...

                                                    {
                                                        ...
                                                        <div className={`flex`}>
                                                            <div>
                                                                <IoLocationSharp className={`inline h-[15.7px]`}/>
                        ...
                        <div className={`bg-white`}>
                            <div className={`flex justify-between`}>
                                <div className={`w-full lg:1/2`}>
                                    ...
                                    <div className={`price_inr text-[9px]`}>
                                        onwards
                                    </div>
                        ...
                        <div className={`pt-2`}>
                            <div className={`btn_listing _btn_clr cursor-pointer w-full text-center text-[12px]`} 
            ...
            }
            {
                ...
                <>
                    ...
                    <Link href={`/qna/${data.tg.cityName}-${data.tg.id}/`}>
                        <div className="anchore_coment _w100 _m_" href={`/qna/${data.tg.cityName}-${data.tg.id}/`}>
                            <div>
                                View All QNA
                            </div>
