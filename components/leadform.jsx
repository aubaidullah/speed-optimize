...
const DatePicker = dynamic(() =>
  import("@amir04lm26/react-modern-calendar-date-picker"),
);
            ...
            <>
              <div className={`text-center mb-[15px]`}>
                ...
                <p className={`text-center text-[10px]`}>
                  ...
                  on <span className={`text-[#f16625]`}>+919650687940</span> or
                  drop a mail on{" "}
                  <a
                      ...
                      {country.map((item, index) => {
                        return (
                          <option
                            key={index}
                            value={item.isdCode}
                            selected={item.isdCode == "91" ? true : false}
                          >
                            {item.code} +{item.isdCode}
                          </option>
                        );
                      })}
                    </select>
