...
export const QNALoading = () => {
    return(
        <div>
            <div style={{marginTop:'30px',background:'white',paddingLeft:'66px'}}>
...
export const TableLoading = () =>{
    return(
        ...
        <div style={{marginTop:"30px",marginBottom:"0px",backgroundColor:'white',padding:'20px',borderRadius:'10px'}}>
