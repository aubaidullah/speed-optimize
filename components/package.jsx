                                ...
                                {/* <Link href={`/holidays/[name]-tour-package-[id]/`} as={`${url}`} prefetch={true}> */}
                                    <div className={tw`flex flex-wrap`}>
                                        ...
                                        {/* <Link href={`/holidays/[name]-tour-package-[id]/`} as={`${url}`} prefetch={true}></Link> */}
                                            ...
                                            {/* <div> */}
                                            <Link href={`${url}`} as={`${url}`} className={tw`w-full lg:w-2/3 px-0 lg:px-2`}>
                                            {/* <a href={`${url}`}> */}
                                                <div href={`${url}`}>
                                                    <div className="contain_blk">
                                                        <div className="_row ov_auto mb_display_none">
                                                            <div className="flt_left">
                                                                <div>
                                                                    <h2 className={`pack_title text-xl text-gray-500`}>{item.name}</h2>
                                                                ...
                                                                <div className="_div">
                                                                    <div>
                                                                        <div className={`flex text-center`}>
                                                                            <MdOutlineFlight className={`h-6 lst_aty text-[#c6c5c5]`} size={20}/> 
                                                        ...
                                                        <div className={`flex items-center justify-between`}>
                                                            ...
                                                            <div className='text-left'>
                                                                <div className={`flex checks`}>
                                                                    <p>
                                                                        <MdCheckCircle className={`inline text-[#15be03]`} /> Free Cancellation
                                                                        {/* <br/><MdCheckCircle className='inline' style={{color:'#15be03'}} /> Part Payment */}
                                                                    </p>
                                                                    <p className={`pl-2`}>
                                                                        <MdCheckCircle className={`inline text-[#15be03]`} /> Part Payment
                                                                    </p>
                                                            ...
                                                            <div className='text-right'>
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <div>
                                                                        <p className={`text-[8.8px] text-[#999]`}>Per person on twin sharing</p>
                                                                    </div>
