        ...
        <div className="bottom_bar">
          <div className={`h-full`}>
            <div className={`flex h-full shadow-[3px 1px 4px]`}>
              ...
              >
                <div className="bottom_bt text-[22px]">Send Query</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="p-2">
            ...
            <div className="bestson_list _border_right">
              <div className="best_session">
                ...
                <span>
                  {" "}
                  {data?.package.season.split(",").length === 12 ? (
                    "round-the-year"
                  ) : (
                    // data?.package.season
                      ...
                      {data?.package.season.split(",").map((e, index) => {
                        return (
                          <span key={index}>
                            {/* <span> */}
                            {e}
                            {data?.package.season.split(",")[
                              data?.package.season.split(",").length - 1
                            ] != e
                              ? ", "
                              : ""}
                            {/* </span> */}
        ...
        <div className="_b_right_list __btn_clr price_banner">
          ...
          "priceCurrency": "INR"
                ...
                <div className="_person_">
                  {parseInt(data?.package.price) > 0 ? "(Taxes extra)" : ""} Per
                  Person{" "}
                </div>
              </div>
          ...
          <div className={`bets_price pl-0`}>
            ...
            <div className="tour_planner">
              ...
              <p>
                ...
                your trip and makes it a memorable one
              </p>
            </div>
