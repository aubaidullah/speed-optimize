          ...
          <div className={``}>
            <div className="relative">
              ...
              <select className="form-control-hotel">
                <option
                  value=""
                  onClick={() => updateHotel({ travellers: 2, room: 1 })}
                >
                  2 Travellers, 1 Room
                </option>
                <option
                  value=""
                  onClick={() => updateHotel({ travellers: 3, room: 1 })}
                >
                  3 Travellers, 1 Room
                </option>
                <option
                  value=""
                  onClick={() => updateHotel({ travellers: 4, room: 2 })}
                >
                  4 Travellers, 2 Rooms
                </option>
                <option
                  value=""
                  onClick={() => updateHotel({ travellers: 5, room: 2 })}
                >
                  5 Travellers, 2 Rooms
                </option>
                <option
                  value=""
                  onClick={() => updateHotel({ travellers: 6, room: 3 })}
                >
                  6 Travellers, 3 Rooms
                </option>
                <option
                  value=""
                  onClick={() => updateHotel({ travellers: 7, room: 3 })}
                >
                  7 Travellers, 3 Rooms
                </option>
                {/* <option value="" onClick={()=>updateHotel({travellers:7,room:4})}>7 Travellers, 4 Rooms</option> */}
                <option
                  value=""
                  onClick={() => updateHotel({ travellers: 8, room: 4 })}
                >
                  8 Travellers, 4 Rooms
                </option>
                <option
                  value=""
                  onClick={() => updateHotel({ travellers: 9, room: 4 })}
                >
                  9 Travellers, 4 Rooms
                </option>
                {/* <option value="" onClick={()=>updateHotel({travellers:9,room:5})}>9 Travellers, 5 Rooms</option> */}
                <option
                  value=""
                  onClick={() => updateHotel({ travellers: 10, room: 5 })}
                >
                  10 Travellers, 5 Rooms
                </option>
              </select>
            </div>
          </div>
